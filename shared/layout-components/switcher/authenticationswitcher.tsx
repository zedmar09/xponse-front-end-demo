            ...
            <HelmetProvider>
                <Helmet>
                    <html dir={local_varaiable.dir}
                        className={`h-full ${local_varaiable.class}`}
                ...
                >
                                ...
                                <div className="grid grid-cols-2 gap-6 switcher-style">
                                    ...
                                    <div className="flex">
                                        <input type="radio" name="sidemenu-layout-styles" className="ti-form-radio" id="switcher-icon-overlay"
                                            checked={local_varaiable.dataToggled == "icon-overlay-close"} onChange={e => { }}
                    ...
                    <div className="ti-offcanvas-footer">
                        <Link className="ti-btn ti-btn-primary" target='_blank' href="https://themeforest.net/user/spruko/portfolio">Try Now</Link>
                        <Link className="ti-btn ti-btn-secondary" target='_blank' href="https://themeforest.net/user/spruko/portfolio">Our Portfolio</Link>
                        <Link id="reset-all" className="ti-btn ti-btn-danger" href="#!" onClick={() => switcherdata.Reset(ThemeChanger)} >Reset</Link>
                    </div>
                </div>
            </HelmetProvider>
        </Fragment>
