...
const Switcher = ({ local_varaiable, ThemeChanger }: any) => {
    ...
    useEffect(() => {
        ThemeChanger({
            ...
            "class": "light",
            "dataToggled": "",
            "colorPrimaryRgb": "240,64,67",
            "colorPrimary": "240,64,67",
        });
    }, []);
                ...
                >
                    ...
                    <div className="ti-offcanvas-body" id="switcher-body">
                        <div id="switcher-1" role="tabpanel" aria-labelledby="switcher-item-1" className="space-y-6">
                            ...
                            <div className="!my-0">
                                ...
                                <div className="px-4 text-secondary text-xs mb-4"><b className="lt:mr-2 rtl:ml-2">Note:</b>Works same for both Vertical and
                                    Horizontal
                                </div>
                            </div>
                            <div className="!my-0">
                            ...
                            <div className="!my-0 sidemenu-layout-styles">
                                ...
                                <div className="grid grid-cols-2 gap-6 switcher-style">
                                    ...
                                    <div className="flex">
                                        <input type="radio" name="sidemenu-layout-styles" className="ti-form-radio" id="switcher-closed-menu"
                                            checked={local_varaiable.dataToggled == "close-menu-close"} onChange={e => { }}
                                    ...
                                    <div className="flex">
                                        <input type="radio" name="sidemenu-layout-styles" className="ti-form-radio" id="switcher-icontext-menu"
                                            checked={local_varaiable.dataToggled == "icon-text-close"} onChange={e => { }}
                                    ...
                                    <div className="flex">
                                        <input type="radio" name="sidemenu-layout-styles" className="ti-form-radio" id="switcher-detached"
                                            checked={local_varaiable.dataToggled == "detached-close"} onChange={e => { }}
                                    ...
                                    <div className="flex">
                                        <input type="radio" name="sidemenu-layout-styles" className="ti-form-radio" id="switcher-double-menu"
                                            checked={local_varaiable.dataToggled == "double-menu-open"} onChange={e => { }}
                                ...
                                <div className="px-4 text-secondary text-xs mb-4"><b className="ltr:mr-2 rtl:ml-2">Note:</b>Navigation menu styles {`won't`} work
                                    here.</div>
                            </div>
                        </div>
                                ...
                                <div className="flex switcher-style space-x-3 rtl:space-x-reverse">
                                    ...
                                    <div className="ti-form-radio switch-select">
                                        <input className="ti-form-radio color-input color-primary-3" type="radio" name="theme-primary"
                                            checked={local_varaiable.colorPrimaryRgb == '172, 172 ,80'} onChange={(_e) => { }}
                                    ...
                                    <div className="ti-form-radio switch-select">
                                        <input className="ti-form-radio color-input color-primary-4" type="radio" name="theme-primary"
                                            checked={local_varaiable.colorPrimaryRgb == '165, 94, 131'} onChange={(_e) => { }}
                                    ...
                                    <div className="ti-form-radio switch-select">
                                        <input className="ti-form-radio color-input color-primary-5" type="radio" name="theme-primary"
                                            checked={local_varaiable.colorPrimaryRgb == '87, 68, 117'} onChange={(_e) => { }}
                  ...
                  <div className='pickr-container-background'>
                    ...
                    <div className="ti-offcanvas-footer">
                        <Link id="reset-all" className="ti-btn ti-btn-danger w-full" href="#!" onClick={() => switcherdata.Reset(ThemeChanger)} >Reset</Link>
                    </div>
                </div>
            </HelmetProvider>
        </Fragment>
